...
public:
    ...
    virtual int32_t GetSpanSizeInFrame(uint32_t sessionId, uint32_t &spanSizeInFrame)
    {
        return ERR_NOT_SUPPORTED;
    }
...
protected:
    static bool AdjustFrameLen(HpaeNodeInfo &inNodeInfo, const HpaeNodeInfo &outNodeInfo);
