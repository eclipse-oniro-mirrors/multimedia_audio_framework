...
namespace HPAE {
#define HDI_INVALID_RENDER_ID 0xFFFFFFFF
...
enum HpaeProcessorType {
    ...
    // scene for collaborative record
    HPAE_SCENE_COLLABORATIVE_RECORD = 27,
};
...
struct HpaeDfxNodeInfo {
    ...
    uint32_t renderId = HDI_INVALID_RENDER_ID;
...
public:
    ...
    virtual void OnCollborationFadeDone(uint32_t sessionId){};
    virtual void OnDisConnectCoBufferWaitFadeOutDone(){};
};
