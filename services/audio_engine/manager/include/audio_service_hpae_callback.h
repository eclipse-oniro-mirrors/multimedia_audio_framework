...
public:
    ...
    virtual void OnGetCollaborativeUpdateCb(int32_t result) = 0;

    virtual void OnUpdateSpatializationStateCb(int32_t result) = 0;

    virtual void OnUpdatePersonalizedHRTFBinCb(int32_t result) = 0;
