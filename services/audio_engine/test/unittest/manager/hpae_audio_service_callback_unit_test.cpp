...
void HpaeAudioServiceCallbackUnitTest::OnGetCollaborativeUpdateCb(int32_t result)
{
    getCollaborativeUpdateResult_ = result;
}

void HpaeAudioServiceCallbackUnitTest::OnUpdateSpatializationStateCb(int32_t result)
{
    updateSpatializationStateResult_ = result;
}

void HpaeAudioServiceCallbackUnitTest::OnUpdatePersonalizedHRTFBinCb(int32_t result)
{
...
int32_t HpaeAudioServiceCallbackUnitTest::GetGetCollaborativeUpdateResult() const noexcept
{
