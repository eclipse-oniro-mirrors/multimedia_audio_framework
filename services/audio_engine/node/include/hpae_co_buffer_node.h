...
public:
    ...
    void SetDefaultRendererManagerCallBack(std::weak_ptr<INodeCallback> defaultRendererManagerCallBack);
private:
...
#endif
    std::weak_ptr<INodeCallback> defaultRendererManagerCallBack_;
};
}  // namespace HPAE
}  // namespace AudioStandard
}  // namespace OHOS
