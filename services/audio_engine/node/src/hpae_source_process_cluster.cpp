...
OutputPort<HpaePcmBuffer *> *HpaeSourceProcessCluster::GetOutputPort(HpaeNodeInfo &nodeInfo, bool isDisConnect)
{
    ...
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(SafeGetMap(fmtConverterNodeMap_, sourceOutputNodeKey),
        ...
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            ...
            "not find the sourceOutputNodeKey", false),
...
{
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(captureEffectNode_, ERROR_ILLEGAL_STATE,
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            BuildErrorCode(ProblemCategory::FAULT_NO_SOUND, OperationType::RECORD,
                BusinessScenario::CREATE, ERR_NULL_POINTER),
            "captureEffectNode_ is nullptr", false),
        "captureEffectNode_ is nullptr");
    HpaeNodeInfo nodeInfo;
...
{
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(captureEffectNode_, 0,
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            BuildErrorCode(ProblemCategory::FAULT_STATE_INCONSISTENT, OperationType::RECORD,
                BusinessScenario::QUERY, ERR_NULL_POINTER),
            "captureEffectNode_ is nullptr", false),
...
int32_t HpaeSourceProcessCluster::SetAppsEnhanceMuteState(bool isMute)
{
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(captureEffectNode_, ERROR_ILLEGAL_STATE,
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            BuildErrorCode(ProblemCategory::FAULT_NO_SOUND, OperationType::RECORD,
            ...
            "captureEffectNode_ is nullptr", false),
        "captureEffectNode_ is nullptr");
    return captureEffectNode_->SetAppsEnhanceMuteState(isMute);
}
}  // namespace HPAE
}  // namespace AudioStandard
}  // namespace OHOS