...
namespace AudioStandard {
    ...
    constexpr uint32_t MIN_STREAMID_2 = UINT32_MAX - MIN_SESSIONID + DEFAULT_STREAM_ID;
    constexpr uint32_t MIN_STREAMID_3 = UINT32_MAX - MIN_SESSIONID - DEFAULT_STREAM_ID;
