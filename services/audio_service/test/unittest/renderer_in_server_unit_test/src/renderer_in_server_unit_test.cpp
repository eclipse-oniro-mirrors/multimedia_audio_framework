...
void RendererInServerUnitTest::SetUp(void)
{
    ...
    stateListener = streamListenerHolder;
 ...
 * @tc.type  : FUNC
 * @tc.number: RendererInServerSetVoipNoPrivacyFlag_001
 * @tc.desc  : Test renderer-side voip no privacy flag sync interface.
 */
HWTEST_F(RendererInServerUnitTest, RendererInServerSetVoipNoPrivacyFlag_001, TestSize.Level1)
{
    processConfig.deviceType = DEVICE_TYPE_INVALID;
    processConfig.rendererInfo.rendererFlags = AUDIO_FLAG_MMAP;
    processConfig.rendererInfo.voipNoPrivacyFlag = false;
    rendererInServer = std::make_shared<RendererInServer>(processConfig, streamListener);
    ASSERT_NE(nullptr, rendererInServer);

    EXPECT_FALSE(rendererInServer->GetVoipNoPrivacyFlag());
    EXPECT_EQ(SUCCESS, rendererInServer->SetVoipNoPrivacyFlag(true));
    EXPECT_TRUE(rendererInServer->GetVoipNoPrivacyFlag());
}
 ...
 * @tc.name  : Test RendererInServer
 * @tc.type  : FUNC
 * @tc.number: CalculateCacheCount_001
 * @tc.desc  : Test CalculateCacheCount with normal input
 */
HWTEST_F(RendererInServerUnitTest, CalculateCacheCount_001, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo, DEVICE_TYPE_USB_HEADSET, AUDIO_USAGE_NORMAL);
    ...
    uint32_t cacheSizeInFrame = 20;
    uint32_t cacheCount = 0;
    ret = rendererInServer->CalculateCacheCount(cacheSizeInFrame, cacheCount);
    EXPECT_EQ(ret, SUCCESS);
    EXPECT_GT(cacheCount, 0);
    EXPECT_LE(cacheCount, 6);
}

/**
 * @tc.name  : Test RendererInServer
 * @tc.type  : FUNC
 * @tc.number: CalculateCacheCount_002
 * @tc.desc  : Test CalculateCacheCount when cacheSizeInFrame > spanSizeInFrame_ * 6
 */
HWTEST_F(RendererInServerUnitTest, CalculateCacheCount_002, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo, DEVICE_TYPE_USB_HEADSET, AUDIO_USAGE_NORMAL);
    ...
    uint32_t cacheSizeInFrame = 1000;
    uint32_t cacheCount = 0;
    ret = rendererInServer->CalculateCacheCount(cacheSizeInFrame, cacheCount);
    EXPECT_EQ(ret, SUCCESS);
}
 ...
 * @tc.name  : Test RendererInServer
 * @tc.type  : FUNC
 * @tc.number: CalculateCacheCount_003
 * @tc.desc  : Test CalculateCacheCount when buffer not configured
 */
HWTEST_F(RendererInServerUnitTest, CalculateCacheCount_003, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo, DEVICE_TYPE_USB_HEADSET, AUDIO_USAGE_NORMAL);
    ...
    uint32_t cacheSizeInFrame = 20;
    uint32_t cacheCount = 0;
    int32_t ret = rendererInServer->CalculateCacheCount(cacheSizeInFrame, cacheCount);
 ...
 * @tc.name  : Test RendererInServer
 * @tc.type  : FUNC
 * @tc.number: CalculateCacheCount_004
 * @tc.desc  : Test CalculateCacheCount when spanSizeInFrame is 0
 */
HWTEST_F(RendererInServerUnitTest, CalculateCacheCount_004, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo, DEVICE_TYPE_USB_HEADSET, AUDIO_USAGE_NORMAL);
    ...
    rendererInServer->isBufferConfiged_ = true;
 ...
 * @tc.name  : Test RendererInServer
 * @tc.type  : FUNC
 * @tc.number: CalculateCacheCount_005
 * @tc.desc  : Test CalculateCacheCount with normal input
 */
HWTEST_F(RendererInServerUnitTest, CalculateCacheCount_005, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo, DEVICE_TYPE_USB_HEADSET, AUDIO_USAGE_NORMAL);
    ...
    EXPECT_EQ(ret, SUCCESS);
    EXPECT_GT(cacheCount, 0);
    EXPECT_LE(cacheCount, 5);
}

/**
 * @tc.name  : Test RendererInServer
 * @tc.type  : FUNC
 * @tc.number: CalculateCacheCount_006
 * @tc.desc  : Test CalculateCacheCount when cacheSizeInFrame > spanSizeInFrame_ * 5
 */
HWTEST_F(RendererInServerUnitTest, CalculateCacheCount_006, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo, DEVICE_TYPE_USB_HEADSET, AUDIO_USAGE_NORMAL);
    ...
    EXPECT_EQ(ret, SUCCESS);
    cacheCount = 0;
    rendererInServer->isBufferConfiged_ = false;
    ret = rendererInServer->CalculateCacheCount(cacheSizeInFrame, cacheCount);
    EXPECT_EQ(ret, ERR_INVALID_PARAM);
...
/**
 * @tc.name  : Test CheckIsUnderrun API
 * @tc.type  : FUNC
 * @tc.number: RendererInServerCheckIsUnderrun_001
 * @tc.desc  : Test CheckIsUnderrun when managerType_ is PLAYBACK and currentReadFrame >= currentWriteFrame.
 */
HWTEST_F(RendererInServerUnitTest, RendererInServerCheckIsUnderrun_001, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
    ...
    // Set managerType_ to PLAYBACK (non-DIRECT_PLAYBACK)
    rendererInServer->managerType_ = PLAYBACK;
    rendererInServer->spanSizeInFrame_ = 100;

    // Test: managerType_ != DIRECT_PLAYBACK && currentReadFrame >= currentWriteFrame -> return true
    uint64_t currentReadFrame = 100;
    uint64_t currentWriteFrame = 50;
    bool result = rendererInServer->CheckIsUnderrun(currentReadFrame, currentWriteFrame);
    EXPECT_TRUE(result);
}
 ...
 * @tc.name  : Test CheckIsUnderrun API
 * @tc.type  : FUNC
 * @tc.number: RendererInServerCheckIsUnderrun_002
 * @tc.desc  : Test CheckIsUnderrun when managerType_ is PLAYBACK and currentReadFrame < currentWriteFrame.
 */
HWTEST_F(RendererInServerUnitTest, RendererInServerCheckIsUnderrun_002, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
    ...
    // Test: managerType_ != DIRECT_PLAYBACK && currentReadFrame < currentWriteFrame -> return false
    uint64_t currentReadFrame = 50;
    uint64_t currentWriteFrame = 100;
    bool result = rendererInServer->CheckIsUnderrun(currentReadFrame, currentWriteFrame);
    EXPECT_FALSE(result);
}
 ...
 * @tc.name  : Test CheckIsUnderrun API
 * @tc.type  : FUNC
 * @tc.number: RendererInServerCheckIsUnderrun_003
 * @tc.desc  : Test CheckIsUnderrun when managerType_ is DIRECT_PLAYBACK and
 *             currentReadFrame + spanSizeInByte_ > currentWriteFrame.
 */
HWTEST_F(RendererInServerUnitTest, RendererInServerCheckIsUnderrun_003, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
    ...
    // Set managerType_ to DIRECT_PLAYBACK
    rendererInServer->managerType_ = DIRECT_PLAYBACK;
    rendererInServer->spanSizeInFrame_ = 100;

    // Test: managerType_ == DIRECT_PLAYBACK && (currentReadFrame + spanSizeInByte_) > currentWriteFrame -> return true
    uint64_t currentReadFrame = 10;
    uint64_t currentWriteFrame = 50;
    // currentReadFrame(10) + spanSizeInByte_(100) = 110 > currentWriteFrame(50) -> true
    bool result = rendererInServer->CheckIsUnderrun(currentReadFrame, currentWriteFrame);
    EXPECT_TRUE(result);
}
 ...
 * @tc.name  : Test CheckIsUnderrun API
 * @tc.type  : FUNC
 * @tc.number: RendererInServerCheckIsUnderrun_004
 * @tc.desc  : Test CheckIsUnderrun when managerType_ is DIRECT_PLAYBACK and
 *             currentReadFrame + spanSizeInByte_ <= currentWriteFrame.
 */
HWTEST_F(RendererInServerUnitTest, RendererInServerCheckIsUnderrun_004, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
    ...
    uint64_t currentReadFrame = 10;
    uint64_t currentWriteFrame = 150;
    // currentReadFrame(10) + spanSizeInByte_(100) = 110 <= currentWriteFrame(150) -> false
    bool result = rendererInServer->CheckIsUnderrun(currentReadFrame, currentWriteFrame);
    EXPECT_FALSE(result);
}
 ...
 * @tc.name  : Test CheckIsUnderrun API
 * @tc.type  : FUNC
 * @tc.number: RendererInServerCheckIsUnderrun_005
 * @tc.desc  : Test CheckIsUnderrun when managerType_ is DIRECT_PLAYBACK and
 *             currentReadFrame + spanSizeInByte_ == currentWriteFrame (boundary condition).
 */
HWTEST_F(RendererInServerUnitTest, RendererInServerCheckIsUnderrun_005, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
    ...
    // Test: managerType_ == DIRECT_PLAYBACK && (currentReadFrame + spanSizeInByte_) == currentWriteFrame
    // Since condition is > (not >=), this should return false
    uint64_t currentReadFrame = 50;
    uint64_t currentWriteFrame = 150;
    // currentReadFrame(50) + spanSizeInByte_(100) = 150 == currentWriteFrame(150) -> false (not >)
    bool result = rendererInServer->CheckIsUnderrun(currentReadFrame, currentWriteFrame);
    EXPECT_FALSE(result);
}
 ...
 * @tc.name  : Test CheckIsUnderrun API
 * @tc.type  : FUNC
 * @tc.number: RendererInServerCheckIsUnderrun_006
 * @tc.desc  : Test CheckIsUnderrun when managerType_ is PLAYBACK and
 *             currentReadFrame == currentWriteFrame (boundary condition).
 */
HWTEST_F(RendererInServerUnitTest, RendererInServerCheckIsUnderrun_006, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
 ...
 * @tc.name  : Test CheckIsUnderrun API
 * @tc.type  : FUNC
 * @tc.number: RendererInServerCheckIsUnderrun_007
 * @tc.desc  : Test CheckIsUnderrun with VOIP_PLAYBACK managerType_.
 */
HWTEST_F(RendererInServerUnitTest, RendererInServerCheckIsUnderrun_007, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
    ...
    // Set managerType_ to VOIP_PLAYBACK (non-DIRECT_PLAYBACK)
    rendererInServer->managerType_ = VOIP_PLAYBACK;
    rendererInServer->spanSizeInFrame_ = 100;

    // Test: currentReadFrame >= currentWriteFrame -> return true (applies to all manager types)
    uint64_t currentReadFrame = 100;
    uint64_t currentWriteFrame = 50;
    bool result = rendererInServer->CheckIsUnderrun(currentReadFrame, currentWriteFrame);
    EXPECT_TRUE(result);
 ...
 * @tc.name  : Test CheckIsUnderrun API
 * @tc.type  : FUNC
 * @tc.number: RendererInServerCheckIsUnderrun_008
 * @tc.desc  : Test CheckIsUnderrun when managerType_ is DIRECT_PLAYBACK and
 *             currentReadFrame >= currentWriteFrame (basic underrun check).
 */
HWTEST_F(RendererInServerUnitTest, RendererInServerCheckIsUnderrun_008, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
    ...
    // Test: currentReadFrame >= currentWriteFrame should return true for DIRECT_PLAYBACK too
    // (basic underrun check applies to all manager types)
    uint64_t currentReadFrame = 150;
    uint64_t currentWriteFrame = 100;
    bool result = rendererInServer->CheckIsUnderrun(currentReadFrame, currentWriteFrame);
    EXPECT_TRUE(result);
}
...
/**
 * @tc.name  : Test Standby API
 * @tc.type  : FUNC
 * @tc.number: RendererInServerStandby_001
 * @tc.desc  : Test Standby API when asyncHandler_ is valid.
 */
HWTEST_F(RendererInServerUnitTest, RendererInServerStandby_001, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_INVALID, SAMPLE_S24LE, MONO,
        AudioChannelLayout::CH_LAYOUT_UNKNOWN);
    InitAudioProcessConfig(testStreamInfo);
    ...
    ret = rendererInServer->Standby(true);
    EXPECT_EQ(SUCCESS, ret);
}
 ...
 * @tc.name  : Test Standby API
 * @tc.type  : FUNC
 * @tc.number: RendererInServerStandby_002
 * @tc.desc  : Test Standby API when asyncHandler_ is nullptr.
 */
HWTEST_F(RendererInServerUnitTest, RendererInServerStandby_002, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_INVALID, SAMPLE_S24LE, MONO,
        AudioChannelLayout::CH_LAYOUT_UNKNOWN);
    InitAudioProcessConfig(testStreamInfo);
    ...
    rendererInServer->asyncHandler_ = nullptr;
    
    int32_t ret = rendererInServer->Standby(true);
    EXPECT_EQ(ERR_OPERATION_FAILED, ret);
}

/**
 * @tc.name  : Test StartInnerDuringStandby API
 * @tc.type  : FUNC
 * @tc.number: RendererInServerStartInnerDuringStandby_001
 * @tc.desc  : Test StartInnerDuringStandby when asyncHandler_ is valid.
 */
HWTEST_F(RendererInServerUnitTest, RendererInServerStartInnerDuringStandby_001, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_INVALID, SAMPLE_S24LE, MONO,
        AudioChannelLayout::CH_LAYOUT_UNKNOWN);
    InitAudioProcessConfig(testStreamInfo);
    ...
    ret = rendererInServer->StartInnerDuringStandby();
    EXPECT_NE(ERR_OPERATION_FAILED, ret);
}

/**
 * @tc.name  : Test StartInnerDuringStandby API
 * @tc.type  : FUNC
 * @tc.number: RendererInServerStartInnerDuringStandby_002
 * @tc.desc  : Test StartInnerDuringStandby when asyncHandler_ is nullptr.
 */
HWTEST_F(RendererInServerUnitTest, RendererInServerStartInnerDuringStandby_002, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_INVALID, SAMPLE_S24LE, MONO,
        AudioChannelLayout::CH_LAYOUT_UNKNOWN);
    InitAudioProcessConfig(testStreamInfo);
...
/**
 * @tc.name  : Test NotifyStandbyAction Exec
 * @tc.type  : FUNC
 * @tc.number: NotifyStandbyActionExec_001
 * @tc.desc  : Test NotifyStandbyAction Exec when isStandbyOn_ is true.
 */
HWTEST_F(RendererInServerUnitTest, NotifyStandbyActionExec_001, TestSize.Level1)
{
    uint32_t sessionId = 123;
    auto action = std::make_shared<NotifyStandbyAction>(sessionId, true);
 ...
 * @tc.name  : Test NotifyStandbyAction Exec
 * @tc.type  : FUNC
 * @tc.number: NotifyStandbyActionExec_002
 * @tc.desc  : Test NotifyStandbyAction Exec when isStandbyOn_ is false.
 */
HWTEST_F(RendererInServerUnitTest, NotifyStandbyActionExec_002, TestSize.Level1)
{
    uint32_t sessionId = 456;
    auto action = std::make_shared<NotifyStandbyAction>(sessionId, false);
    ASSERT_NE(nullptr, action);
 ...
 */
HWTEST_F(RendererInServerUnitTest, UpdateUnderrunInfo_001, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
    ...
    ret = rendererInServer->UpdateUnderrunInfo(underrunInfoKey, underrunInfoVal);
    EXPECT_EQ(ret, SUCCESS);
}
 ...
 */
HWTEST_F(RendererInServerUnitTest, UpdateUnderrunInfo_002, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
 ...
 */
HWTEST_F(RendererInServerUnitTest, UpdateUnderrunInfo_003, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
...
/**
 * @tc.name  : Test OnStatusUpdate OPERATION_UPDATE_SPANSIZE
 * @tc.type  : FUNC
 * @tc.number: OnStatusUpdate_UpdateSpanSize_001
 * @tc.desc  : Test OnStatusUpdate with OPERATION_UPDATE_SPANSIZE operation.
 */
HWTEST_F(RendererInServerUnitTest, OnStatusUpdate_UpdateSpanSize_001, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
    ...
    rendererInServer->OnStatusUpdate(OPERATION_UPDATE_SPANSIZE);
    EXPECT_NE(nullptr, rendererInServer);
}
 ...
 * @tc.desc  : Test RefreshServerBufferForSpanSizeUpdate with normal stream.
 */
HWTEST_F(RendererInServerUnitTest, RefreshServerBufferForSpanSizeUpdate_001, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
    ...
    ret = rendererInServer->RefreshServerBufferForSpanSizeUpdate(stateListener);
    EXPECT_NE(ERR_ILLEGAL_STATE, ret);
}

/**
 * @tc.name  : Test GetRendererFlagsByRoute API
 * @tc.type  : FUNC
 * @tc.number: GetRendererFlagsByRoute_001
 * @tc.desc  : Cover normal, fast, and voip fast route mapping.
 */
HWTEST_F(RendererInServerUnitTest, GetRendererFlagsByRoute_001, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
    ...
    EXPECT_EQ(rendererInServer->GetRendererFlagsByRoute(0), AUDIO_FLAG_NORMAL);
    EXPECT_EQ(rendererInServer->GetRendererFlagsByRoute(AUDIO_OUTPUT_FLAG_FAST), AUDIO_FLAG_MMAP);
    EXPECT_EQ(rendererInServer->GetRendererFlagsByRoute(AUDIO_OUTPUT_FLAG_FAST | AUDIO_OUTPUT_FLAG_VOIP),
        AUDIO_FLAG_VOIP_FAST);
}

/**
 * @tc.name  : Test UpdateStreamStatusByRendererState
 * @tc.type  : FUNC
 * @tc.number: UpdateStreamStatusByRendererState_001
 * @tc.desc  : Test UpdateStreamStatusByRendererState with started state.
 */
HWTEST_F(RendererInServerUnitTest, UpdateStreamStatusByRendererState_001, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
    ...
    rendererInServer->status_ = I_STATUS_STARTED;
    rendererInServer->UpdateStreamStatusByRendererState();
    EXPECT_NE(nullptr, rendererInServer);
}
 ...
 * @tc.name  : Test UpdateStreamStatusByRendererState
 * @tc.type  : FUNC
 * @tc.number: UpdateStreamStatusByRendererState_002
 * @tc.desc  : Test UpdateStreamStatusByRendererState with paused state.
 */
HWTEST_F(RendererInServerUnitTest, UpdateStreamStatusByRendererState_002, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
 ...
 * @tc.name  : Test UpdateStreamStatusByRendererState
 * @tc.type  : FUNC
 * @tc.number: UpdateStreamStatusByRendererState_003
 * @tc.desc  : Test UpdateStreamStatusByRendererState with stopped state.
 */
HWTEST_F(RendererInServerUnitTest, UpdateStreamStatusByRendererState_003, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
...
/**
 * @tc.name  : Test OnWriteDataNoWake API
 * @tc.type  : FUNC
 * @tc.number: OnWriteDataNoWake_001
 * @tc.desc  : Test OnWriteDataNoWake interface.
 */
HWTEST_F(RendererInServerUnitTest, OnWriteDataNoWake_001, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
    ...
    int8_t data[1024] = {0};
    ret = rendererInServer->OnWriteDataNoWake(data, 1024);
    EXPECT_NE(ERR_ILLEGAL_STATE, ret);
}

/**
 * @tc.name  : Test WakeClientFutex API
 * @tc.type  : FUNC
 * @tc.number: WakeClientFutex_001
 * @tc.desc  : Test WakeClientFutex with audioServerBuffer.
 */
HWTEST_F(RendererInServerUnitTest, WakeClientFutex_001, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
    ...
    rendererInServer->WakeClientFutex();
    EXPECT_NE(nullptr, rendererInServer);
}

/**
 * @tc.name  : Test WakeClientFutex without buffer
 * @tc.type  : FUNC
 * @tc.number: WakeClientFutex_002
 * @tc.desc  : Test WakeClientFutex when audioServerBuffer is null.
 */
HWTEST_F(RendererInServerUnitTest, WakeClientFutex_002, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
...
/**
 * @tc.name  : Test GetLatency with enableNewRoute
 * @tc.type  : FUNC
 * @tc.number: GetLatency_NewRoute_001
 * @tc.desc  : Test GetLatency when enableNewRoute is enabled.
 */
HWTEST_F(RendererInServerUnitTest, GetLatency_NewRoute_001, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
    ...
    rendererInServer->managerType_ = DIRECT_PLAYBACK;
    uint64_t latency = 0;
    ret = rendererInServer->GetLatency(latency);
    EXPECT_NE(ERR_ILLEGAL_STATE, ret);
}

/**
 * @tc.name  : Test Release with loopback renderer
 * @tc.type  : FUNC
 * @tc.number: Release_Loopback_001
 * @tc.desc  : Test Release with loopback renderer info.
 */
HWTEST_F(RendererInServerUnitTest, Release_Loopback_001, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
    processConfig.rendererInfo.isLoopback = true;
    rendererInServer = std::make_shared<RendererInServer>(processConfig, streamListener);
    EXPECT_NE(nullptr, rendererInServer);

    rendererInServer->Release();
    EXPECT_NE(nullptr, rendererInServer);
}

/**
 * @tc.name  : Test StartInner with FAST stream
 * @tc.type  : FUNC
 * @tc.number: StartInner_FastBypass_001
 * @tc.desc  : Test StartInner bypasses WaitForDataConnection for FAST stream.
 */
HWTEST_F(RendererInServerUnitTest, StartInner_FastBypass_001, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
    processConfig.rendererInfo.audioFlag = AUDIO_OUTPUT_FLAG_FAST;
    rendererInServer = std::make_shared<RendererInServer>(processConfig, streamListener);
    EXPECT_NE(nullptr, rendererInServer);
...
HWTEST_F(RendererInServerUnitTest, RefreshServerBufferForSpanSizeUpdate_ZeroSpan_001, TestSize.Level1)
{
    AudioStreamInfo testStreamInfo(SAMPLE_RATE_48000, ENCODING_PCM, SAMPLE_S16LE, MONO,
        AudioChannelLayout::CH_LAYOUT_MONO);
    InitAudioProcessConfig(testStreamInfo);
    ...
    rendererInServer->spanSizeInFrame_ = 0;
    rendererInServer->RefreshServerBufferForSpanSizeUpdate(stateListener);
}
} // namespace AudioStandard
} // namespace OHOS
