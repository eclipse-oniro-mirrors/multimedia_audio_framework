...
public:
    ...
    int32_t UpdateSessionOperation(uint32_t sessionId, uint32_t operation, uint32_t opMsg,
        bool needRemoveFromMap) override;
    ...
    int32_t NotifySessionStandbyStatus(uint32_t sessionId, bool standbyStatus) override;
private:
