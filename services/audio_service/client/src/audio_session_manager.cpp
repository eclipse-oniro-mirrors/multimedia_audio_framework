...
int32_t AudioSessionManager::SetMediaOutputDevice(DeviceType deviceType)
{
    return AudioSessionClientManager::GetInstance().SetMediaOutputDevice(deviceType);
}
...
int32_t AudioSessionManager::SetCapturerMuteHint(bool mute)
{
    return AudioSessionClientManager::GetInstance().SetCapturerMuteHint(mute);
}
...
int32_t AudioSessionManager::SetAudioSessionBehavior(const uint32_t behavior)
{
    return AudioSessionClientManager::GetInstance().SetAudioSessionBehavior(behavior);
}

void AudioSessionManager::SetRegisterStateChangeCallbackFlag(const bool stateChangeCallbackFlag)
{
    AudioSessionClientManager::GetInstance().SetRegisterStateChangeCallbackFlag(stateChangeCallbackFlag);
}
