...
namespace {
    static const std::vector<std::pair<AudioVolumeType, DeviceGroup>> g_volumeIndexVector = {
        ...
        {STREAM_NOTIFICATION, DEVICE_GROUP_EARPIECE},
        {STREAM_NOTIFICATION, DEVICE_GROUP_BUILT_IN},
        {STREAM_NOTIFICATION, DEVICE_GROUP_WIRELESS},
        {STREAM_NOTIFICATION, DEVICE_GROUP_WIRED},
        {STREAM_NOTIFICATION, DEVICE_GROUP_REMOTE_CAST},
        {STREAM_NOTIFICATION, DEVICE_GROUP_DP},
        ...
        {STREAM_NAVIGATION, DEVICE_GROUP_EARPIECE},
        {STREAM_NAVIGATION, DEVICE_GROUP_BUILT_IN},
        {STREAM_NAVIGATION, DEVICE_GROUP_WIRELESS},
        {STREAM_NAVIGATION, DEVICE_GROUP_WIRED},
        {STREAM_NAVIGATION, DEVICE_GROUP_REMOTE_CAST},
        {STREAM_NAVIGATION, DEVICE_GROUP_DP},
#endif
...
public:
    ...
    virtual int32_t GetRemoteDeviceName(const std::string &deviceId, std::string &deviceName) = 0;
