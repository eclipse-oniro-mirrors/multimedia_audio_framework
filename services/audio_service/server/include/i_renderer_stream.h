...
public:
    ...
    virtual int32_t OnWriteDataNoWake(int8_t *inputData, size_t requestDataLen) { return 0; }
    virtual void WakeClientFutex() {}
};
...
public:
    ...
    virtual void TriggerClientWake() {}
};
...
public:
    ...
    virtual uint32_t GetRouteFlag() const noexcept { return 0; }
};
