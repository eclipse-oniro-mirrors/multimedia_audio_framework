...
private:
    ...
    size_t ringBufferCapacityInBytes_ = 0;
    ...
    bool delayedWake_ = false;
    std::atomic<uint32_t> routeFlag_ = 0;
};
} // namespace AudioStandard
} // namespace OHOS
