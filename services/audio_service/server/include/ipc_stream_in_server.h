...
public:
    ...
    int32_t SetVoipNoPrivacyFlag(bool voipNoPrivacyFlag) override; // renderer only
    ...
    int32_t CalculateCacheCount(uint32_t cacheSizeInFrame, uint32_t &cacheCount) override;
