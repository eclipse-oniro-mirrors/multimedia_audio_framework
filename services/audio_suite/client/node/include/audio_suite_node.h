...
public:
    ...
    virtual void ReadPreNodeData(PcmBufferFormat outFormat, bool needConvert, uint32_t needDataLength);
    ...
    virtual const PcmBufferFormat &GetAudioNodeOutPcmFormat();
    ...
    virtual int32_t PrintNodeInfo(std::string &nodeInfo);
...
protected:
    ...
    // Format conversion buffers (temporary storage for format conversion)
    std::vector<AudioSuitePcmBuffer> formatConversionBuffers_;
