...
public:
    ...
    int32_t AddAudioZoneVolumeProxy(int32_t zoneId, DeviceType deviceType,
        const std::shared_ptr<AudioZoneVolumeProxy> &proxy);
    int32_t RemoveAudioZoneVolumeProxy(int32_t zoneId, DeviceType deviceType);
...
private:
        ...
        std::unordered_map<int32_t, std::unordered_map<DeviceType,
            std::shared_ptr<AudioZoneVolumeProxy>>> audioZoneDeviceVolumeProxyMap_;
        ...
        int32_t OnInterruptEvent(int32_t zoneId, const std::string &deviceTag,
            const std::vector<std::map<AudioInterrupt, int32_t>> &ipcInterrupts,
            int32_t reason) override;
        int32_t SetSystemVolume(int32_t zoneId, int32_t deviceTypeIn, int32_t volumeTypeIn,
            int32_t volumeLevel, int32_t volumeDegree, int32_t volumeFlag) override;
        int32_t GetSystemVolume(int32_t zoneId, int32_t deviceTypeIn, int32_t volumeTypeIn,
            int32_t &outVolume) override;
        int32_t GetSystemVolumeDegree(int32_t zoneId, int32_t deviceTypeIn, int32_t volumeTypeIn,
            int32_t &outVolume) override;
};
} // namespace AudioStandard
} // namespace OHOS
