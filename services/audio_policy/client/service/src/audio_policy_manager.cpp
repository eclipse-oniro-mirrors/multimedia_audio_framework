...
int32_t AudioPolicyManager::RegisterPolicyCallbackClientFunc(const sptr<IAudioPolicy> &gsp)
{
    ...
    if (audioPolicyClientStubCB_ == nullptr) {
        ...
        CHECK_AND_CALL_FUNC_RETURN_RET_LOG(audioPolicyClientStubCB_ != nullptr, ERROR,
            StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
                SESSION_CALLBACK_NULL_POINTER, "audioPolicyClientStubCB_ is nullptr", true),
            "audioPolicyClientStubCB_ is nullptr");
    }
    sptr<IRemoteObject> object = audioPolicyClientStubCB_->AsObject();
    if (object == nullptr) {
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            SESSION_CALLBACK_NULL_POINTER, "audioPolicyClientStubCB_->AsObject is nullptr", true);
...
int32_t AudioPolicyManager::SetCallbackStreamInfo(const CallbackChange &callbackChange)
{
    ...
    if (callbackChange == CALLBACK_PREFERRED_OUTPUT_DEVICE_CHANGE) {
        for (auto &[rendererInfo, uid] : rendererInfosWithUid_) {
            ret = gsp->SetCallbackRendererInfo(rendererInfo, uid);
        }
    } else if (callbackChange == CALLBACK_PREFERRED_INPUT_DEVICE_CHANGE) {
        for (auto &[capturerInfo, uid] : capturerInfosWithUid_) {
            ret = gsp->SetCallbackCapturerInfo(capturerInfo, uid);
        }
    }
    return ret;
}
...
int32_t AudioPolicyManager::SetSystemAppVolumePercentageForUid(int32_t appUid, int32_t volumePercentage)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, -1, "audio policy manager proxy is NULL.");
    return gsp->SetSystemAppVolumePercentageForUid(appUid, volumePercentage);
}
...
int32_t AudioPolicyManager::IsAppVolumeMute(int32_t appUid, bool owned, bool &isMute)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, -1, "audio policy manager proxy is NULL.");
    return gsp->IsAppVolumeMute(appUid, owned, isMute);
}
...
int32_t AudioPolicyManager::GetSystemAppVolumePercentageForUid(int32_t appUid, int32_t &volumePercentage)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, -1, "audio policy manager proxy is NULL.");
    return gsp->GetSystemAppVolumePercentageForUid(appUid, volumePercentage);
}
...
bool AudioPolicyManager::IsMultichannelPlaybackSupported(AudioStreamInfo &streamInfo, StreamUsage streamUsage)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, false, "audio policy manager proxy is NULL.");

    bool support = false;
    gsp->IsMultichannelPlaybackSupported(streamInfo, static_cast<int32_t>(streamUsage), support);
    return support;
}

bool AudioPolicyManager::IsDirectPlaybackSupported(AudioStreamInfo &streamInfo, StreamUsage streamUsage)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, false, "audio policy manager proxy is NULL.");

    bool support = false;
    gsp->IsDirectPlaybackSupported(streamInfo, static_cast<int32_t>(streamUsage), support);
    return support;
}

bool AudioPolicyManager::IsOffloadPlaybackSupported(AudioStreamInfo &streamInfo, StreamUsage streamUsage)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, false, "audio policy manager proxy is NULL.");

    bool support = false;
    gsp->IsOffloadPlaybackSupported(streamInfo, static_cast<int32_t>(streamUsage), support);
    return support;
}
...
int32_t AudioPolicyManager::SetCallbackCapturerInfo(const AudioCapturerInfo &capturerInfo, const int32_t uid)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, -1, "audio policy manager proxy is NULL.");
    return gsp->SetCallbackCapturerInfo(capturerInfo, uid);
}
...
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(gsp != nullptr, ERROR,
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            INTERRUPT_CALLBACK_NULL_POINTER, "audio policy manager proxy is NULL", true),
        "audio policy manager proxy is NULL.");
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(callback != nullptr, ERR_INVALID_PARAM,
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            INTERRUPT_CALLBACK_INVALID_PARAM, "callback is nullptr", true),
        "callback is nullptr");

    sptr<AudioPolicyManagerListenerStubImpl> listener = new(std::nothrow) AudioPolicyManagerListenerStubImpl();
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(listener != nullptr, ERROR,
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            INTERRUPT_CALLBACK_NULL_POINTER, "object null", true),
        "object null");
    listener->SetInterruptCallback(callback);

    sptr<IRemoteObject> object = listener->AsObject();
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(object != nullptr, ERROR,
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            INTERRUPT_CALLBACK_NULL_POINTER, "listenerStub->AsObject is nullptr", true),
        "listenerStub->AsObject is nullptr..");
...
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(gsp != nullptr, -1,
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            INTERRUPT_CALLBACK_NULL_POINTER, "audio policy manager proxy is NULL", true),
        "audio policy manager proxy is NULL.");
...
int32_t AudioPolicyManager::SetAncoSourceOutputStreamMute(int32_t uid, bool setMute)
{
    AUDIO_INFO_LOG("In");
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, ERROR, "audio policy manager proxy is NULL.");
    return gsp->SetAncoSourceOutputStreamMute(uid, setMute);
}
    ...
    AudioInterrupt &audioInterrupt, const int32_t zoneID, const bool isUpdatedAudioStrategy)
{
    ...
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(gsp != nullptr, -1,
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            ...
            RECORD_INTERRUPT_START_NULL_POINTER : INTERRUPT_START_NULL_POINTER,
            "audio policy manager proxy is NULL", true),
        "audio policy manager proxy is NULL.");
    return gsp->ActivateAudioInterrupt(audioInterrupt, zoneID, isUpdatedAudioStrategy);
}

int32_t AudioPolicyManager::SetRegisterInterruptCallbackFlag(const uint32_t streamId, const bool interruptCallbackFlag)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, ERROR, "audio policy manager proxy is NULL.");
    return gsp->SetRegisterInterruptCallbackFlag(streamId, interruptCallbackFlag);
}
...
int32_t AudioPolicyManager::SetOffloadAllowedForUid(uint32_t uid, bool allowed)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, -1, "audio policy manager proxy is NULL.");
    return gsp->SetOffloadAllowedForUid(uid, allowed);
}
    ...
    bool isRemoveFocusHis)
{
    ...
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(gsp != nullptr, -1,
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            audioInterrupt.audioFocusType.sourceType != SOURCE_TYPE_INVALID ?
            RECORD_INTERRUPT_STOP_NULL_POINTER : INTERRUPT_STOP_NULL_POINTER,
            "audio policy manager proxy is NULL", true),
        "audio policy manager proxy is NULL.");
    return gsp->DeactivateAudioInterrupt(audioInterrupt, zoneID, isRemoveFocusHis);
}
...
int32_t AudioPolicyManager::GetAudioDebugInfo(uint32_t sessionId, AudioDebugInfo &audioDebugInfo)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, ERROR, "audio policy manager proxy is NULL.");
    std::shared_ptr<AudioDebugInfo> audioDebugInfoPtr = nullptr;
    int32_t ret = gsp->GetAudioDebugInfo(sessionId, audioDebugInfoPtr);
    CHECK_AND_RETURN_RET_LOG(ret == SUCCESS, ret, "GetAudioDebugInfo failed, ret:%{public}d", ret);
    CHECK_AND_RETURN_RET_LOG(audioDebugInfoPtr != nullptr, ERR_OPERATION_FAILED,
        "GetAudioDebugInfo failed: audioDebugInfo is nullptr");
    audioDebugInfo = *audioDebugInfoPtr;
    return SUCCESS;
}

int32_t AudioPolicyManager::GetSessionDebugInfo(AudioSessionDebugInfo &sessionDebugInfo)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, ERROR, "audio policy manager proxy is NULL.");
    std::shared_ptr<AudioSessionDebugInfo> sessionDebugInfoPtr = nullptr;
    int32_t ret = gsp->GetSessionDebugInfo(sessionDebugInfoPtr);
    CHECK_AND_RETURN_RET_LOG(ret == SUCCESS, ret, "GetSessionDebugInfo failed, ret:%{public}d", ret);
    CHECK_AND_RETURN_RET_LOG(sessionDebugInfoPtr != nullptr, ERR_OPERATION_FAILED,
        "GetSessionDebugInfo failed: sessionDebugInfo is nullptr");
    sessionDebugInfo = *sessionDebugInfoPtr;
    return SUCCESS;
}
    ...
    const std::shared_ptr<AudioDistributedRoutingRoleCallback> &callback)
{
    ...
    std::lock_guard<std::mutex> lock(listenerStubMutex_);
...
int32_t AudioPolicyManager::GetCurrentSpatialAudioSourceType()
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, ERROR, "audio policy manager proxy is NULL.");
    int32_t ret = SPATIAL_AUDIO_SOURCE_TYPE_STEREO;
    gsp->GetCurrentSpatialAudioSourceType(ret);
    return ret;
}
...
int32_t AudioPolicyManager::SetPersonalizedSpatializationEnabled(
    const std::shared_ptr<AudioDeviceDescriptor> &selectedAudioDevice, const bool enable)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, ERROR, "audio policy manager proxy is NULL.");
    return gsp->SetPersonalizedSpatializationEnabled(selectedAudioDevice, enable);
}

bool AudioPolicyManager::IsPersonalizedSpatializationEnabled(const std::string address)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, false, "audio policy manager proxy is NULL.");
    bool ret = false;
    gsp->IsPersonalizedSpatializationEnabled(address, ret);
    return ret;
}

int32_t AudioPolicyManager::DownloadPersonalizedHRTF(const int32_t fd, const int64_t length)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, ERROR, "audio policy manager proxy is NULL.");
    return gsp->DownloadPersonalizedHRTF(fd, length);
}
...
int32_t AudioPolicyManager::RegisterSpatializationEnabledEventListener(
    const std::shared_ptr<AudioSpatializationEnabledChangeCallback> &callback, bool isFromNearlink)
{
    ...
    if (audioPolicyClientStubCB_ != nullptr) {
        audioPolicyClientStubCB_->AddSpatializationEnabledChangeCallback(callback, isFromNearlink);
...
int32_t AudioPolicyManager::RegisterHeadTrackingEnabledEventListener(
    const std::shared_ptr<AudioHeadTrackingEnabledChangeCallback> &callback, bool isFromNearlink)
{
    AUDIO_DEBUG_LOG("Start to register");
    CHECK_AND_RETURN_RET_LOG(callback != nullptr, ERR_INVALID_PARAM, "callback is nullptr");
    ...
    if (audioPolicyClientStubCB_ != nullptr) {
        audioPolicyClientStubCB_->AddHeadTrackingEnabledChangeCallback(callback, isFromNearlink);
...
int32_t AudioPolicyManager::RegisterSpatialAudioSourceTypeEventListener(
    const std::shared_ptr<AudioSpatialAudioSourceTypeChangeCallback> &callback)
{
    ...
    std::lock_guard<std::mutex> lockCbMap(
        callbackChangeInfos_[CALLBACK_SPATIAL_AUDIO_SOURCE_TYPE_CHANGE].mutex);
    if (audioPolicyClientStubCB_ != nullptr) {
        audioPolicyClientStubCB_->AddSpatialAudioSourceTypeChangeCallback(callback);
        size_t callbackSize = audioPolicyClientStubCB_->GetCurrentSpatialAudioSourceTypeChangeCallbackSize();
        if (callbackSize == 1) {
            callbackChangeInfos_[CALLBACK_SPATIAL_AUDIO_SOURCE_TYPE_CHANGE].isEnable = true;
            SetClientCallbacksEnable(CALLBACK_SPATIAL_AUDIO_SOURCE_TYPE_CHANGE, true);
        }
    }
    return SUCCESS;
}

int32_t AudioPolicyManager::RegisterPersonalizedSpatializationEnabledEventListener(
    const std::shared_ptr<AudioPersonalizedSpatializationEnabledChangeCallback> &callback)
{
    ...
    std::lock_guard<std::mutex> lockCbMap(
        callbackChangeInfos_[CALLBACK_PERSONALIZE_SPATIALIZATION_ENABLED_CHANGE].mutex);
    if (audioPolicyClientStubCB_ != nullptr) {
        audioPolicyClientStubCB_->AddPersonalizedSpatializationEnabledChangeCallback(callback);
        size_t callbackSize = audioPolicyClientStubCB_->GetPersonalizedSpatializationEnabledChangeCallbackSize();
        if (callbackSize == 1) {
            callbackChangeInfos_[CALLBACK_PERSONALIZE_SPATIALIZATION_ENABLED_CHANGE].isEnable = true;
            SetClientCallbacksEnable(CALLBACK_PERSONALIZE_SPATIALIZATION_ENABLED_CHANGE, true);
        }
    }
    return SUCCESS;
}
...
int32_t AudioPolicyManager::UnregisterSpatialAudioSourceTypeEventListener()
{
    AUDIO_DEBUG_LOG("Start to unregister");
    std::lock_guard<std::mutex> lockCbMap(
        callbackChangeInfos_[CALLBACK_SPATIAL_AUDIO_SOURCE_TYPE_CHANGE].mutex);
    if (audioPolicyClientStubCB_ != nullptr) {
        audioPolicyClientStubCB_->RemoveSpatialAudioSourceTypeChangeCallback();
        if (audioPolicyClientStubCB_->GetCurrentSpatialAudioSourceTypeChangeCallbackSize() == 0) {
            callbackChangeInfos_[CALLBACK_SPATIAL_AUDIO_SOURCE_TYPE_CHANGE].isEnable = false;
            SetClientCallbacksEnable(CALLBACK_SPATIAL_AUDIO_SOURCE_TYPE_CHANGE, false);
        }
    }
    return SUCCESS;
}

int32_t AudioPolicyManager::UnregisterPersonalizedSpatializationEnabledEventListener()
{
    AUDIO_DEBUG_LOG("Start to unregister");
    std::lock_guard<std::mutex> lockCbMap(
        callbackChangeInfos_[CALLBACK_PERSONALIZE_SPATIALIZATION_ENABLED_CHANGE].mutex);
    if (audioPolicyClientStubCB_ != nullptr) {
        audioPolicyClientStubCB_->RemovePersonalizedSpatializationEnabledChangeCallback();
        if (audioPolicyClientStubCB_->GetPersonalizedSpatializationEnabledChangeCallbackSize() == 0) {
            callbackChangeInfos_[CALLBACK_PERSONALIZE_SPATIALIZATION_ENABLED_CHANGE].isEnable = false;
            SetClientCallbacksEnable(CALLBACK_PERSONALIZE_SPATIALIZATION_ENABLED_CHANGE, false);
        }
    }
    return SUCCESS;
}
...
bool AudioPolicyManager::IsPersonalizedSpatializationSupported()
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, false, "audio policy manager proxy is NULL.");
    bool ret = false;
    gsp->IsPersonalizedSpatializationSupported(ret);
    return ret;
}
...
int32_t AudioPolicyManager::ActivateAudioSession(const AudioSessionStrategy &strategy,
    const bool stateChangeCallbackFlag)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(gsp != nullptr, ERROR,
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            SESSION_START_NULL_POINTER, "audio policy manager proxy is NULL", true),
        "audio policy manager proxy is NULL.");
    if (!isAudioPolicyClientRegisted_) {
        int32_t result = RegisterPolicyCallbackClientFunc(gsp);
        if (result != SUCCESS) {
            StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
                SESSION_START_OPERATION_FAILED, "Failed to register policy callback client", true);
            AUDIO_ERR_LOG("Failed to register policy callback clent");
            return result;
        }
    }
    return gsp->ActivateAudioSession(static_cast<int32_t>(strategy.concurrencyMode), stateChangeCallbackFlag);
}
...
int32_t AudioPolicyManager::DeactivateAudioSession()
{
    ...
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(gsp != nullptr, ERROR,
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            SESSION_STOP_NULL_POINTER, "audio policy manager proxy is NULL", true),
        "audio policy manager proxy is NULL.");
...
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(gsp != nullptr, false,
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            SESSION_QUERY_NULL_POINTER, "audio policy manager proxy is NULL.", true),
        "audio policy manager proxy is NULL.");
    bool active = false;
...
int32_t AudioPolicyManager::SetAudioSessionCallback(const std::shared_ptr<AudioSessionCallback> &audioSessionCallback)
{
    ...
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(gsp != nullptr, ERROR,
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            SESSION_CALLBACK_NULL_POINTER, "audio policy manager proxy is NULL", true),
        "audio policy manager proxy is NULL.");
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(audioSessionCallback != nullptr, ERR_INVALID_PARAM,
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            SESSION_CALLBACK_INVALID_PARAM, "audioSessionCallback is nullptr", true),
        "audioSessionCallback is nullptr");
    ...
    if (!isAudioPolicyClientRegisted_) {
        ...
        if (result != SUCCESS) {
            StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
                SESSION_CALLBACK_REGISTER_FAILED, "Failed to register policy callback client", true);
            AUDIO_ERR_LOG("Failed to register policy callback clent");
            return result;
        }
    }
    if (audioPolicyClientStubCB_ == nullptr) {
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            SESSION_CALLBACK_NULL_POINTER, "audioPolicyClientStubCB_ is null", true);
        AUDIO_ERR_LOG("audioPolicyClientStubCB_ is null");
    ...
    if (result != SUCCESS) {
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            SESSION_CALLBACK_REGISTER_FAILED, "Failed to add audio session callback", true);
...
int32_t AudioPolicyManager::UnsetAudioSessionCallback()
{
    ...
    if (result != SUCCESS) {
        ...
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            SESSION_CALLBACK_UNREGISTER_FAILED, "Failed to remove all audio session callbacks.", true);
        return result;
    }
    ...
    const std::shared_ptr<AudioSessionCallback> &audioSessionCallback)
{
    ...
    if (result != SUCCESS) {
        ...
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            SESSION_CALLBACK_UNREGISTER_FAILED, "Failed to remove the audio session callback.", true);
        return result;
    }
...
int32_t AudioPolicyManager::SetAudioSessionScene(const AudioSessionScene audioSessionScene)
{
    ...
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(gsp != nullptr, ERROR,
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            SESSION_CONFIG_NULL_POINTER, "audio policy manager proxy is NULL.", true),
        "audio policy manager proxy is NULL.");
    if (!isAudioPolicyClientRegisted_) {
        int32_t result = RegisterPolicyCallbackClientFunc(gsp);
        if (result != SUCCESS) {
...
int32_t AudioPolicyManager::SetRegisterStateChangeCallbackFlag(const bool stateChangeCallbackFlag)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, ERROR, "audio policy manager proxy is NULL.");
    if (!isAudioPolicyClientRegisted_) {
        int32_t result = RegisterPolicyCallbackClientFunc(gsp);
        if (result != SUCCESS) {
            AUDIO_ERR_LOG("Failed to register policy callback client");
            return result;
        }
    }
    return gsp->SetRegisterStateChangeCallbackFlag(stateChangeCallbackFlag);
}
    ...
    const std::shared_ptr<AudioSessionStateChangedCallback> &stateChangedCallback)
{
    ...
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(gsp != nullptr, ERROR,
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            SESSION_CALLBACK_NULL_POINTER, "audio policy manager proxy is NULL", true),
        "audio policy manager proxy is NULL.");
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(stateChangedCallback != nullptr, ERR_INVALID_PARAM,
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            SESSION_CALLBACK_INVALID_PARAM, "stateChangedCallback is nullptr", true),
        "stateChangedCallback is nullptr");
    ...
    if (result != SUCCESS) {
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            SESSION_CALLBACK_REGISTER_FAILED, "Failed to add audio session state callback", true);
        AUDIO_ERR_LOG("Failed to add audio session callback.");
        return result;
    }
...
int32_t AudioPolicyManager::UnsetAudioSessionStateChangeCallback()
{
    ...
    if (result != SUCCESS) {
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            SESSION_CALLBACK_UNREGISTER_FAILED, "Failed to remove all audio session state callbacks", true);
    ...
    const std::shared_ptr<AudioSessionStateChangedCallback> &stateChangedCallback)
{
    ...
    if (result != SUCCESS) {
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            SESSION_CALLBACK_UNREGISTER_FAILED, "Failed to remove the audio session state callback", true);
...
int32_t AudioPolicyManager::EnableMuteSuggestionWhenMixWithOthers(bool enable)
{
    ...
    if (!isAudioPolicyClientRegisted_) {
        ...
        if (result != SUCCESS) {
            StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
                SESSION_CONFIG_OPERATION_FAILED, "Failed to register policy callback client", true);
            AUDIO_ERR_LOG("Failed to register policy callback clent");
            return result;
        }
    }
...
int32_t AudioPolicyManager::SetAudioSessionCapturerMuteHint(bool mute)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(gsp != nullptr, ERROR,
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
            RECORD_INTERRUPT_CONFIG_NULL_POINTER, "audio policy manager proxy is NULL", true),
        "audio policy manager proxy is NULL.");
    return gsp->SetAudioSessionCapturerMuteHint(mute);
}
...
int32_t AudioPolicyManager::SetAudioRouteSelectorCallback(const std::shared_ptr<AudioRouteSelector> &callback)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, ERROR, "audio policy manager proxy is NULL.");
    CHECK_AND_RETURN_RET_LOG(callback != nullptr, ERR_INVALID_PARAM, "callback is nullptr");
    ...
    std::lock_guard<std::mutex> lockCbMap(callbackChangeInfos_[CALLBACK_ROUTE_SELECTOR].mutex);
    audioPolicyClientStubCB_->SetAudioRouteSelectorCallback(callback);
    if (audioPolicyClientStubCB_->HasAudioRouteSelectorCallback()) {
        callbackChangeInfos_[CALLBACK_ROUTE_SELECTOR].isEnable = true;
        SetClientCallbacksEnable(CALLBACK_ROUTE_SELECTOR, true);
    }

    return SUCCESS;
}

int32_t AudioPolicyManager::UnsetAudioRouteSelectorCallback()
{
    std::lock_guard<std::mutex> lockCbMap(callbackChangeInfos_[CALLBACK_ROUTE_SELECTOR].mutex);
    if (audioPolicyClientStubCB_ != nullptr) {
        audioPolicyClientStubCB_->UnsetAudioRouteSelectorCallback();
        callbackChangeInfos_[CALLBACK_ROUTE_SELECTOR].isEnable = false;
        SetClientCallbacksEnable(CALLBACK_ROUTE_SELECTOR, false, false);
    }
    return SUCCESS;
}
...
int32_t AudioPolicyManager::SetSplitModeReady()
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, -1, "audio policy manager proxy is NULL.");
    return gsp->SetSplitModeReady();
}
...
bool AudioPolicyManager::SetLoopbackVolume(float volume)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, false, "audio policy manager proxy is NULL.");
    bool ret = false;
    gsp->SetLoopbackVolume(volume, ret);
    return ret;
}

float AudioPolicyManager::GetLoopbackVolume()
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, 0.0f, "audio policy manager proxy is NULL.");
    float volume = 0.0f;
    bool ret = false;
    gsp->GetLoopbackVolume(volume, ret);
    CHECK_AND_RETURN_RET_LOG(ret, 0.0f, "GetLoopbackVolume failed");
    return volume;
}

int32_t AudioPolicyManager::CreateLoopback(AudioLoopbackMode mode, LoopbackType type,
    const sptr<IRemoteObject> &callback, sptr<IRemoteObject> &loopback)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, ERR_NULL_POINTER, "audio policy manager proxy is NULL.");
    int32_t result = SUCCESS;
    gsp->CreateLoopback(static_cast<int32_t>(mode), static_cast<int32_t>(type), callback, loopback, result);
    return result;
}

int32_t AudioPolicyManager::DestroyLoopback(LoopbackType type)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, ERR_NULL_POINTER, "audio policy manager proxy is NULL.");
    int32_t result = SUCCESS;
    gsp->DestroyLoopback(static_cast<int32_t>(type), result);
    return result;
}
...
std::vector<AudioDevicePair> AudioPolicyManager::GetLoopbackSupportedDevicePairs()
{
    Trace trace("AudioPolicyManager::GetLoopbackSupportedDevicePairs");
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, {}, "audio policy manager proxy is NULL.");
    ...
    int32_t ret = 0;
    gsp->GetLoopbackSupportedDevicePairs(inputDevices, outputDevices, ret);

    std::vector<AudioDevicePair> devicePairs;
    CHECK_AND_RETURN_RET(ret == SUCCESS && !inputDevices.empty() && !outputDevices.empty(), devicePairs);

    CHECK_AND_RETURN_RET_LOG(inputDevices.size() == outputDevices.size(),
        devicePairs, "inputDevices size %{public}zu not match outputDevices size %{public}zu",
        inputDevices.size(), outputDevices.size());

    for (size_t i = 0; i < inputDevices.size(); i++) {
        devicePairs.push_back(std::make_pair(inputDevices[i], outputDevices[i]));
    }

    return devicePairs;
}

AudioDevicePair AudioPolicyManager::GetLoopbackPreferredDevicePair()
{
    Trace trace("AudioPolicyManager::GetLoopbackPreferredDevicePair");
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, {}, "audio policy manager proxy is NULL.");

    std::shared_ptr<AudioDeviceDescriptor> inputDevice;
    std::shared_ptr<AudioDeviceDescriptor> outputDevice;
    int32_t ret = 0;
    gsp->GetLoopbackPreferredDevicePair(inputDevice, outputDevice, ret);

    CHECK_AND_RETURN_RET(ret == SUCCESS && inputDevice != nullptr && outputDevice != nullptr, {});

    return std::make_pair(inputDevice, outputDevice);
}
...
bool AudioPolicyManager::IsCollaborativePlaybackSupportedForDevice(
    const std::shared_ptr<AudioDeviceDescriptor> &selectedAudioDevice)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, false, "audio policy manager proxy is NULL.");
    bool isSupported = false;
    gsp->IsCollaborativePlaybackSupportedForDevice(selectedAudioDevice, isSupported);
    return isSupported;
}
...
int32_t AudioPolicyManager::UpdateSafeVolumeByStrMode()
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, ERROR, "audio policy manager proxy is NULL.");

    return gsp->UpdateSafeVolumeByStrMode();
}

int32_t AudioPolicyManager::RecordBootAnimationClientStateTime(const BootAnimationInfo &info)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, ERROR, "audio policy manager proxy is NULL.");

    return gsp->RecordBootAnimationClientStateTime(info);
}
...
int32_t AudioPolicyManager::SetAudioSessionBehavior(const uint32_t behavior)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_CALL_FUNC_RETURN_RET_LOG(gsp != nullptr, ERROR,
        StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
    ...
    if (!isAudioPolicyClientRegisted_) {
        ...
        CHECK_AND_CALL_FUNC_RETURN_RET_LOG(result == SUCCESS, result,
            StreamDfxManager::GetInstance().SendAudioErrorEvent(static_cast<int32_t>(getuid()),
                SESSION_CONFIG_OPERATION_FAILED, "RegisterPolicyCallbackClientFunc failed", true),
            "RegisterPolicyCallbackClientFunc failed");
    }
    return gsp->SetAudioSessionBehavior(behavior);
}

int32_t AudioPolicyManager::GetActiveStreamsVolumeInfo(
    std::vector<ActiveStreamVolumeInfo> &activeStreamsVolumeInfo)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, ERROR, "audio policy manager proxy is NULL.");
    return gsp->GetActiveStreamsVolumeInfo(activeStreamsVolumeInfo);
}

int32_t AudioPolicyManager::SetAudioZoneVolumeConfig(const std::string &zoneName,
    const std::vector<AudioZoneVolumeConfig> &configs)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, ERROR, "audio policy manager proxy is NULL.");
    return gsp->SetAudioZoneVolumeConfig(zoneName, configs);
}

int32_t AudioPolicyManager::TriggerAudioZoneVolumeSync()
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, ERROR, "audio policy manager proxy is NULL.");
    return gsp->TriggerAudioZoneVolumeSync();
}

bool AudioPolicyManager::IsAudioSeparationEffectSupported()
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, false, "audio policy manager proxy is NULL.");
    bool ret = false;
    gsp->IsAudioSeparationEffectSupported(ret);
    return ret;
}

int32_t AudioPolicyManager::SetAudioSeparationEffectEnabled(bool enabled, int32_t uid, int64_t streamId)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, ERROR, "audio policy manager proxy is NULL.");
    return gsp->SetAudioSeparationEffectEnabled(enabled, uid, streamId);
}

int32_t AudioPolicyManager::SetAudioSeparationEffectVolume(AudioSeparationVolumeType type, double volume)
{
    const sptr<IAudioPolicy> gsp = GetAudioPolicyManagerProxy();
    CHECK_AND_RETURN_RET_LOG(gsp != nullptr, ERROR, "audio policy manager proxy is NULL.");
    return gsp->SetAudioSeparationEffectVolume(type, volume);
}

int32_t AudioPolicyManager::OnAudioSeparationEffectEnabledChange(
    const std::shared_ptr<AudioSeparationEffectEnabledChangeCallback> &callback)
{
    ...
    CHECK_AND_RETURN_RET_LOG(callback != nullptr, ERR_INVALID_PARAM,
        "Audio separation effect enabled change callback is nullptr");

    int32_t registerRet = callbackChangeInfos_[CALLBACK_AUDIO_SEPARATION_EFFECT_ENABLED_CHANGE].isEnable ? SUCCESS :
        RegisterPolicyCallbackClientFunc(gsp);
    CHECK_AND_RETURN_RET_LOG(registerRet == SUCCESS, registerRet,
        "RegisterPolicyCallbackClientFunc failed in OnAudioSeparationEffectEnabledChange");

    std::lock_guard<std::mutex> lockCbMap(callbackChangeInfos_[CALLBACK_AUDIO_SEPARATION_EFFECT_ENABLED_CHANGE].mutex);
    CHECK_AND_RETURN_RET_LOG(audioPolicyClientStubCB_ != nullptr, SUCCESS,
        "audioPolicyClientStubCB_ is nullptr");
    audioPolicyClientStubCB_->AddAudioSeparationEffectEnabledChangeCallback(callback);
    size_t callbackSize = audioPolicyClientStubCB_->GetAudioSeparationEffectEnabledChangeCallbackSize();
    CHECK_AND_RETURN_RET_LOG(callbackSize >= 1, ERROR, "Add callback failed");
    CHECK_AND_RETURN_RET(callbackSize == 1, SUCCESS);
    callbackChangeInfos_[CALLBACK_AUDIO_SEPARATION_EFFECT_ENABLED_CHANGE].isEnable = true;
    SetClientCallbacksEnable(CALLBACK_AUDIO_SEPARATION_EFFECT_ENABLED_CHANGE, true);
    return SUCCESS;
}

int32_t AudioPolicyManager::OffAudioSeparationEffectEnabledChange()
{
    std::lock_guard<std::mutex> lockCbMap(callbackChangeInfos_[CALLBACK_AUDIO_SEPARATION_EFFECT_ENABLED_CHANGE].mutex);
    CHECK_AND_RETURN_RET_LOG(audioPolicyClientStubCB_ != nullptr, SUCCESS,
        "audioPolicyClientStubCB_ is nullptr");
    audioPolicyClientStubCB_->RemoveAudioSeparationEffectEnabledChangeCallback();
    size_t callbackSize = audioPolicyClientStubCB_->GetAudioSeparationEffectEnabledChangeCallbackSize();
    CHECK_AND_RETURN_RET(callbackSize == 0, SUCCESS);
    callbackChangeInfos_[CALLBACK_AUDIO_SEPARATION_EFFECT_ENABLED_CHANGE].isEnable = false;
    SetClientCallbacksEnable(CALLBACK_AUDIO_SEPARATION_EFFECT_ENABLED_CHANGE, false);
    return SUCCESS;
}
