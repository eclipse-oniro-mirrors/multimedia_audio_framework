...
HWTEST_F(AudioDeviceCommonUnitNextTest, UpdateConnectedDevicesWhenDisconnecting_002, TestSize.Level1)
{
    ...
    strategy.SetCallInputDevice(SYSTEM_UID, INVALID_STREAM_ID, preferredCallCaptureDevice);
...
HWTEST_F(AudioDeviceCommonUnitNextTest, UpdateConnectedDevicesWhenDisconnecting_003, TestSize.Level1)
{
    ...
    strategy.SetMediaInputDevice(SYSTEM_UID, INVALID_STREAM_ID, preferredRecordCaptureDevice);
...
HWTEST_F(AudioDeviceCommonUnitNextTest, ClientDiedDisconnectScoRecognition_002, TestSize.Level1)
{
    ...
    auto inputDeviceDesc = make_shared<AudioDeviceDescriptor>(inputDevice);
    AudioDeviceManager::GetAudioDeviceManager().AddConnectedDevices(inputDeviceDesc);
    AudioRouterSelectStrategy::GetInstance().UpdateCurrentInputDevice(SYSTEM_UID, {inputDeviceDesc});
