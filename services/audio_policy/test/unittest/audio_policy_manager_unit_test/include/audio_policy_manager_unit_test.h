...
public:
    ...
    virtual int32_t SetSplitModeReadyRefined() override {return 0;}
};

class ConcreteAudioRouteSelector : public AudioRouteSelector {
public:
    ...
    {
        (void)routeSelectInfo;
        selectResult = ROUTE_SELECT_RESULT_SUCCESS;
        return 0;
    }
};
