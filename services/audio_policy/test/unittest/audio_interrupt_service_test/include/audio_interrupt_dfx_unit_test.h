...
#ifndef AUDIO_INTERRUPT_DFX_UNIT_TEST_H
#define AUDIO_INTERRUPT_DFX_UNIT_TEST_H
...
class AudioInterruptDfxUnitTest : public testing::Test {
public:
...
#endif // AUDIO_INTERRUPT_DFX_UNIT_TEST_H
