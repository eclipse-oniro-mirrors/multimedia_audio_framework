...
HWTEST_F(AudioDeviceStatusUnitTest, AudioDeviceStatus_002, TestSize.Level1)
{
    ...
    deviceDesc->deviceType_ = DEVICE_TYPE_USB_HEADSET;
...
HWTEST_F(AudioDeviceStatusUnitTest, AudioDeviceStatus_006, TestSize.Level1)
{
    ...
    deviceType = audioDeviceStatus.GetDeviceTypeFromPin(hdiPin);
    EXPECT_EQ(deviceType, DEVICE_TYPE_LINE_DIGITAL);
...
HWTEST_F(AudioDeviceStatusUnitTest, GetModuleNameByType_001, TestSize.Level1)
{
    ...
    AudioCoreConfigManager::GetInstance().GetDeviceClassInfo(deviceClassInfo);
...
/**
* @tc.name  : Test AudioDeviceStatus.
* @tc.number: AudioDeviceStatus_074
* @tc.desc  : Test GetDeviceTypeFromPin interface.
*/
HWTEST_F(AudioDeviceStatusUnitTest, AudioDeviceStatus_074, TestSize.Level1)
{
    AudioPin hdiPin = AUDIO_PIN_NONE;
    DeviceType deviceType = DEVICE_TYPE_NONE;
    AudioDeviceStatus& audioDeviceStatus = AudioDeviceStatus::GetInstance();
...
/**
* @tc.name  : Test AudioDeviceStatus.
* @tc.number: AudioDeviceStatus_075
* @tc.desc  : Test OnDeviceInfoUpdated interface.
*/
HWTEST_F(AudioDeviceStatusUnitTest, AudioDeviceStatus_075, TestSize.Level1)
{
    ...
    devDesc->networkId_ = "networkId";
    devDesc->deviceRole_ = OUTPUT_DEVICE;
    devDesc->exceptionFlag_ = false;
    ...
    DeviceInfoUpdateCommand command = EXCEPTION_FLAG_UPDATE;
    audioDeviceStatus.OnDeviceInfoUpdated(desc, command);
    EXPECT_EQ(desc.exceptionFlag_, true);
}
