...
private:
    ...
    void LoadConfigLibrary(ConverterConfig &result, std::shared_ptr<AudioXmlNode> curNode);
    void LoadConfigChannelLayout(ConverterConfig &result, std::shared_ptr<AudioXmlNode> curNode);
