...
private:
    ...
    int32_t GetPreferredOutputStreamTypeInner(DeviceType deviceType, int32_t flags);

    int32_t GetPreferredInputStreamTypeInner(DeviceType deviceType, int32_t flags);
