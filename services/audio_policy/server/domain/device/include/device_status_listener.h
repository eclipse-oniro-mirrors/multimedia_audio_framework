...
private:
    ...
    static int32_t ParsedDeviceRole(const std::string &info);
    static bool ParseDeviceNameAndAddress(const std::string &info, std::string &deviceName, std::string &portId);
};
