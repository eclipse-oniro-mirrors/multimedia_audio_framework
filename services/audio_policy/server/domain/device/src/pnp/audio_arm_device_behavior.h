...
#ifndef AUDIO_ARM_DEVICE_BEHAVIOR_H
#define AUDIO_ARM_DEVICE_BEHAVIOR_H
...
class AudioArmDeviceBehavior : public IDeviceBehaviorBase {
public:
    AudioArmDeviceBehavior() = default;
    virtual ~AudioArmDeviceBehavior() = default;
...
private:
    void UpdateArmModuleInfo(const std::shared_ptr<AudioDeviceDescriptor> &deviceDesc,
