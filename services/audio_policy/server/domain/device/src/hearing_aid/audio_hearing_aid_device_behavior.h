...
#ifndef AUDIO_HEARING_AID_DEVICE_BEHAVIOR_H
#define AUDIO_HEARING_AID_DEVICE_BEHAVIOR_H

#include "i_device_behavior_base.h"

namespace OHOS {
namespace AudioStandard {
class AudioHearingAidDeviceBehavior : public IDeviceBehaviorBase {
public:
    AudioHearingAidDeviceBehavior() = default;
    virtual ~AudioHearingAidDeviceBehavior() = default;
...
private:
    int32_t LoadHearingAidModule(std::shared_ptr<AudioDeviceDescriptor> deviceDesc,
