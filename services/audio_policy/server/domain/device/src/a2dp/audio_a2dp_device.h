...
public:
    ...
    bool SetA2dpDeviceAbsVolumeSupport(const std::string& device, const bool support, const VolumeScale &volume,
        bool mute);
    bool SetA2dpDeviceVolume(const std::string& device, VolumeScale &volume);
