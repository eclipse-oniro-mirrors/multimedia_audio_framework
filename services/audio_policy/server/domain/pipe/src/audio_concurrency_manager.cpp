 ...
 */
#ifndef LOG_TAG
#define LOG_TAG "AudioConcurrencyManager"
#endif
...
static const std::vector<std::pair<AudioMode, uint32_t>> g_priorityOrder = {
    ...
    {AUDIO_MODE_PLAYBACK, AUDIO_OUTPUT_FLAG_INTERPHONE},
    ...
    {AUDIO_MODE_RECORD, AUDIO_INPUT_FLAG_INTERPHONE},
    {AUDIO_MODE_RECORD, AUDIO_INPUT_FLAG_AI},
    {AUDIO_MODE_RECORD, AUDIO_INPUT_FLAG_LIVE},
...
static const std::map<std::pair<AudioMode, uint32_t>, AudioPipeType> g_pipeTypeMap = {
    ...
    {{AUDIO_MODE_PLAYBACK, AUDIO_OUTPUT_FLAG_INTERPHONE}, PIPE_TYPE_OUT_INTERPHONE},
    ...
    {{AUDIO_MODE_RECORD, AUDIO_INPUT_FLAG_INTERPHONE}, PIPE_TYPE_IN_INTERPHONE},
    {{AUDIO_MODE_RECORD, AUDIO_INPUT_FLAG_AI}, PIPE_TYPE_IN_NORMAL_AI},
    {{AUDIO_MODE_RECORD, AUDIO_INPUT_FLAG_LIVE}, PIPE_TYPE_IN_NORMAL_LIVE},
    {{AUDIO_MODE_RECORD, AUDIO_INPUT_FLAG_NORMAL}, PIPE_TYPE_IN_NORMAL},
};

void AudioConcurrencyManager::Init()
{
    AUDIO_INFO_LOG("AudioConcurrencyManager Init");
...
ConcurrencyAction AudioConcurrencyManager::GetConcurrencyAction(
...
AudioPipeType AudioConcurrencyManager::GetPipeTypeByRouteFlag(uint32_t flag, AudioMode audioMode)
{
