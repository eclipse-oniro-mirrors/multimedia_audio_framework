...
public:
    ...
    void SetOffloadStatus(OffloadAdapter offloadAdapter, uint32_t sessionId, uint32_t ioHandle);
...
private:
    ...
    void SetOffloadStatusInternal(uint32_t sessionId, OffloadAdapter offloadAdapter, uint32_t ioHandle);
