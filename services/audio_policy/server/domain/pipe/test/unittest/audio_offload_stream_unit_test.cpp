...
static const uint32_t TEST_OFFLOAD_IO_HANDLE = 100;
...
{
    testOffloadModule_->SetOffloadStatus(OFFLOAD_IN_PRIMARY,
        TEST_OFFLOAD_IN_PRIMARY_1_SESSION_ID, TEST_OFFLOAD_IO_HANDLE);
