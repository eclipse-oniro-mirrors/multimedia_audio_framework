...
enum class AudioPolicyInterfaceCode {
    ...
    GET_LOOPBACK_SUPPORTED_DEVICE_PAIRS,
    GET_LOOPBACK_PREFERRED_DEVICE_PAIR,
    ...
    SET_SYSTEM_VOLUME_DEGREE,
    GET_SYSTEM_VOLUME_DEGREE,
    GET_MIN_VOLUME_DEGREE,
    UPDATE_SAFE_VOLUME_BY_STR_MODE,
    SET_OFFLOAD_ALLOWED_FOR_UID,
    RECORD_BOOT_ANIMATION_CLIENT_STATE_TIME,
    GET_AUDIO_DEBUG_INFO,
    IS_ENHANCED_ROUTING_SUPPORTED,
    GET_CURRENT_RENDERER_CHANGE_INFOS_FOR_ZONE,
    GET_AUDIO_ZONE_FOR_APP,
    AUDIO_POLICY_MANAGER_CODE_MAX = GET_AUDIO_ZONE_FOR_APP,
};
} // namespace AudioStandard
} // namespace OHOS
