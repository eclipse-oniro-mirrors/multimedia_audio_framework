...
public:
    ...
    int32_t GetRemoteDeviceName(const std::string &deviceId, std::string &deviceName) override;
...
int32_t MockPolicyProvider::GetRemoteDeviceName(const std::string &deviceId, std::string &deviceName)
{
...
AppInfo GetAppInfoData()
{
    AppInfo appInfo;
    appInfo.appUid = GetData<int32_t>();
    appInfo.appTokenId = GetData<uint32_t>();
    appInfo.appPid = GetData<int32_t>();
    appInfo.appFullTokenId = GetData<uint64_t>();
    appInfo.deviceId = "";
    return appInfo;
}
