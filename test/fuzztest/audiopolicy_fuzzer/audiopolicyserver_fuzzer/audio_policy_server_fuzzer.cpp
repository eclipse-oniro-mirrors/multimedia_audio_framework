...
void AudioPolicyServerHandleAudioServerRelatedSystemAbilityFuzzTest()
{
    auto audioPolicyServer = GetServerPtr();
    CHECK_AND_RETURN(audioPolicyServer != nullptr);
    int32_t systemAbilityId = APP_MGR_SERVICE_ID;
    std::string deviceId = "";
    audioPolicyServer->HandleAudioServerRelatedSystemAbility(systemAbilityId, deviceId);
    int32_t systemAbilityId1 = 0;
    audioPolicyServer->HandleAudioServerRelatedSystemAbility(systemAbilityId1, deviceId);
}
...
void AudioPolicyServerIsVolumeLevelValidFuzzTest()
{
    ...
    audioPolicyServer->audioVolumeManager_.IsVolumeLevelValid(streamInFocus, volumeLevel);
}
...
void AudioPolicyServerIsRingerModeValidFuzzTest()
{
    ...
    audioPolicyServer->audioVolumeManager_.IsRingerModeValid(ringMode);
}
...
void AudioPolicyServerGetSystemVolumeLevelNoMuteStateFuzzTest()
{
    ...
    CHECK_AND_RETURN(audioPolicyServer != nullptr);
    AudioStreamType streamInFocus = AudioStreamType::STREAM_ALL;
    audioPolicyServer->audioVolumeManager_.GetSystemVolumeLevelNoMuteStateInterface(streamInFocus);
}
...
void AudioPolicyServerGetSystemVolumeLevelInternalFuzzTest()
{
    ...
    AudioStreamType streamInFocus = AudioStreamType::STREAM_ALL;
    int32_t zoneId = GetData<int32_t>();
    audioPolicyServer->audioVolumeManager_.GetSystemVolumeLevelInterface(streamInFocus, zoneId);
}
...
void AudioPolicyServerCheckCanMuteVolumeTypeByStepFuzzTest()
{
    ...
    int32_t volumeLevel = GetData<int32_t>();
    audioPolicyServer->audioVolumeManager_.CheckCanMuteVolumeTypeByStep(volumeType, volumeLevel);
}
...
void AudioPolicyServerUpdateSystemMuteStateAccordingMusicStateFuzzTest()
{
    ...
    bool isUpdateUi = true;
    AudioStreamType streamType = AudioStreamType::STREAM_ALL;
    audioPolicyServer->audioVolumeManager_.UpdateSystemMuteStateAccordingMusicState(streamType, mute, isUpdateUi);
}
...
void AudioPolicyServerSendMuteKeyEventCbWithUpdateUiOrNotFuzzTest()
{
    ...
    bool isUpdateUi = true;
    AudioStreamType streamType = AudioStreamType::STREAM_ALL;
    audioPolicyServer->audioVolumeManager_.SendMuteKeyEventCbWithUpdateUiOrNot(streamType, isUpdateUi, zoneId);
}
...
void AudioPolicyServerProcUpdateRingerModeForMuteFuzzTest()
{
    ...
    bool mute = true;
    audioPolicyServer->audioVolumeManager_.ProcUpdateRingerModeForMute(updateRingerMode, mute);
}
...
void AudioPolicyServerGetSystemVolumeDbFuzzTest()
{
    ...
    CHECK_AND_RETURN(audioPolicyServer != nullptr);
    AudioStreamType streamType = AudioStreamType::STREAM_ALL;
    audioPolicyServer->audioPolicyManager_.GetSystemVolumeDb(streamType);
}
...
void AudioPolicyServerSetSelfAppVolumeLevelInternalFuzztest()
{
    auto audioPolicyServer = GetServerPtr();
    CHECK_AND_RETURN(audioPolicyServer != nullptr);
    ...
    audioPolicyServer->audioVolumeManager_.SetSelfAppVolumeLevelWithCallback(appUid, volumeLevel, isUpdateUi);
}

void AudioPolicyServerSetSystemVolumeLevelWithOptionFuzztest()
{
    auto audioPolicyServer = GetServerPtr();
    CHECK_AND_RETURN(audioPolicyServer != nullptr);
    ...
    audioPolicyServer->audioVolumeManager_.SetSystemVolumeLevelWithOption(streamType, volumeLevel, zoneId, info);
}
...
void AudioPolicyServerSendVolumeKeyEventCbWithUpdateUiOrNotFuzztest()
{
    ...
    bool isUpdateUi = GetData<bool>();
    int32_t zoneId = GetData<int32_t>();
    audioPolicyServer->audioVolumeManager_.SendVolumeKeyEventCbWithUpdateUiOrNot(streamType, isUpdateUi, zoneId);
}
...
void AudioPolicyServerUpdateMuteStateAccordingToVolLevelFuzztest()
{
    ...
    audioPolicyServer->audioVolumeManager_.UpdateMuteStateAccordingToVolLevel(muteInfo, isUpdateUi);
    volumeLevel = 1;
    mute = true;
    VolInfoForUpdateMute unmuteInfo = { streamType, volumeLevel, mute, zoneId };
    audioPolicyServer->audioVolumeManager_.UpdateMuteStateAccordingToVolLevel(unmuteInfo, isUpdateUi);
}
...
void AudioPolicyServerProcUpdateRingerModeFuzztest()
{
    auto audioPolicyServer = GetServerPtr();
    CHECK_AND_RETURN(audioPolicyServer != nullptr);
    audioPolicyServer->audioVolumeManager_.ringerModeManager_.supportVibrator_ = true;
    audioPolicyServer->audioVolumeManager_.ProcUpdateRingerMode();
    audioPolicyServer->audioVolumeManager_.ringerModeManager_.supportVibrator_ = false;
    audioPolicyServer->audioVolumeManager_.ProcUpdateRingerMode();
}
...
void AudioPolicyServerSetSingleStreamVolumeFuzztest()
{
    ...
    audioPolicyServer->audioVolumeManager_.SetSingleStreamVolume(AudioStreamType::STREAM_RING, volumeLevel, option);
    audioPolicyServer->audioVolumeManager_.SetSingleStreamVolume(AudioStreamType::STREAM_VOICE_ASSISTANT, volumeLevel,
        option);
}
...
void AudioPolicyServerSetSingleStreamVolumeWithDeviceFuzztest()
{
    ...
    auto &audioVolumeManager = audioPolicyServer->audioVolumeManager_;
    audioVolumeManager.SetSingleStreamVolumeWithDevice(streamType, volumeLevel, isUpdateUi, deviceType);
}
...
void AudioPolicyServerIsCollaborativePlaybackSupportedForDeviceFuzzTest()
{
    auto audioPolicyServer = GetServerPtr();
    CHECK_AND_RETURN(audioPolicyServer != nullptr);
    ...
    audioPolicyServer->IsCollaborativePlaybackSupportedForDevice(selectedAudioDevice, isSupported);
}
...
void AudioPolicyServerEnableSystemVolumeProxyFuzzTest()
{
    ...
    bool enable = GetData<bool>();
    DeviceType deviceType = GetData<DeviceType>();
    server->EnableSystemVolumeProxy(zoneId, deviceType, enable);
    server->ReleaseAudioZone(zoneId);
}
...
TestFuncs g_testFuncs[] = {
    ...
    AudioPolicyServerHandleAudioServerRelatedSystemAbilityFuzzTest,
    ...
    AudioPolicyServerSetSelfAppVolumeLevelInternalFuzztest,
    AudioPolicyServerSetSystemVolumeLevelWithOptionFuzztest,
    ...
    AudioPolicyServerIsCollaborativePlaybackSupportedForDeviceFuzzTest,
