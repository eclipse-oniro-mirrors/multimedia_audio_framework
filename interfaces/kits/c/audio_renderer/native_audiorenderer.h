 ...
 * This function can only apply on audiorenderers whose streamUsage is
 * STREAM_USAGE_VOICE_COMMUNICATION/STREAM_USAGE_VIDEO_COMMUNICATION/STREAM_USAGE_VOICE_MESSAGE
 * Setting the device will only take effect if no other accessory such as headphones are in use
 * 
 * @since 13
 *
 * @param renderer Renderer generated by OH_AudioStreamBuilder_GenerateRenderer()
 * @param deviceType the available deviceTypes is EARPIECE/SPEAKER/DEFAULT
