...
// Channel layout to channel number mapping table
inline static const std::unordered_map<AudioChannelLayout, AudioChannel> LAYOUT_TO_CHANNEL = {
...
struct AudioFormat {
    ...
    AudioChannelInfo outAudioChannelInfo;
    AudioSampleFormat outFormat = INVALID_WIDTH;
    AudioSamplingRate outRate = SAMPLE_RATE_48000;
