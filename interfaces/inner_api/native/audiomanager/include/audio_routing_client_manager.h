...
#ifndef AUDIO_ROUTING_CLIENT_MANAGER_H
#define AUDIO_ROUTING_CLIENT_MANAGER_H
...
class AudioRoutingClientManager {
public:
    static AudioRoutingClientManager &GetInstance();
    ...
    int32_t SetDeclaredDeviceTypes(std::vector<DeviceType> &deviceTypeVector);
...
#endif // AUDIO_ROUTING_CLIENT_MANAGER_H
