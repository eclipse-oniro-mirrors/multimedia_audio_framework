...
public:
    ...
    static void SetLegacyVolumeNotificationLevel(int32_t level);
    static int32_t GetLegacyVolumeNotificationLevel();
...
private:
    ...
    static void InitLevelToDegreeMap(int32_t maxLevel);
    ...
    static int32_t legacyVolumeNotificationLevel_;
    ...
    // maxLevel -> {level, degree}
    static inline std::unordered_map<int32_t, std::map<int32_t, int32_t>> levelToDegreeMap_;
};
} // namespace AudioStandard
} // namespace OHOS
