...
#define CHECK_AND_CALL_FUNC_RETURN_REPORT(cond, func1, func2) \
    do {                                               \
        if (!(cond)) {                                 \
            func1;                                     \
            func2;                                     \
...
#define CHECK_AND_CALL_FUNC_RETURN_RET_REPORT(cond, ret, func1, func2) \
    do {                                               \
        if (!(cond)) {                                 \
            func1;                                     \
            func2;                                     \
...
#define CHECK_AND_CALL_FUNC_RETURN_HILOG(cond, func, fmt, ...) \
    do {                                               \
        if (!(cond)) {                                 \
            HILOG_COMM_ERROR(fmt, ##__VA_ARGS__);      \
            func;                                      \
            return;                                    \
        }                                              \
    } while (0)

#define CHECK_AND_CALL_FUNC_RETURN_RET_HILOG(cond, ret, func, fmt, ...) \
    do {                                               \
        if (!(cond)) {                                 \
            HILOG_COMM_ERROR(fmt, ##__VA_ARGS__);      \
            func;                                      \
