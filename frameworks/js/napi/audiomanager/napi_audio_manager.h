...
struct AudioManagerAsyncContext : public ContextBase {
    ...
    static napi_value GetDeviceEnhanceManager(napi_env env, napi_callback_info info);
    static napi_value GetDebugManager(napi_env env, napi_callback_info info);
    ...
    static napi_value ReportPlaybackCaptureUserChoice(napi_env env, napi_callback_info info);
