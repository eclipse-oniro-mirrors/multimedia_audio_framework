...
public:
    ...
    static int32_t GetPreferredInputDevice(OHOS::AudioStandard::AudioCapturerOptions *opts,
        AudioCapturerOptions const &options);
    ...
    static int32_t GetRendererOptions(OHOS::AudioStandard::AudioRendererOptions *opts,
        AudioRendererOptions const &options);
    static int32_t GetAppInfo(OHOS::AudioStandard::AppInfo &appInfo, AppIdInfo const &options);
    ...
    static int32_t GetAudioDeviceTypeVector(std::vector<OHOS::AudioStandard::DeviceType> &deviceTypeVector,
        array_view<DeviceType> in);
    ...
    static int32_t UniqueEffectPropertyData(OHOS::AudioStandard::AudioEffectPropertyArray &propertyArray);
    static int32_t GetEffectPropertyArray(OHOS::AudioStandard::AudioEffectPropertyArray &propertyArray,
    ...
    static AudioSamplingRateOrInt ToTaiheAudioSamplingRate(OHOS::AudioStandard::AudioSamplingRate audioSamplingRate);
    static int32_t GetIntValueFromSamplingRateUnion(AudioSamplingRateOrInt const &samplingRate);
    static bool IsRendererCustomSampleRateValid(int32_t sampleRate);
    static bool IsValidAudioSamplingRate(int32_t sampleRate);
    ...
    static taihe::array<ActiveStreamVolumeInfo> ToTaiheActiveStreamsVolumeInfo(
        const std::vector<OHOS::AudioStandard::ActiveStreamVolumeInfo> &activeStreamsVolumeInfo);
    static ActiveStreamVolumeInfo ToTaiheActiveStreamVolumeInfo(
