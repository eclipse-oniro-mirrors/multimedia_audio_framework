...
static const std::map<OHOS::AudioStandard::DeviceType, DeviceType> DEVICE_TYPE_TAIHE_MAP = {
    ...
    {OHOS::AudioStandard::DeviceType::DEVICE_TYPE_BT_SPP, DeviceType::key_t::BLUETOOTH_SPP},
    {OHOS::AudioStandard::DeviceType::DEVICE_TYPE_NEARLINK_PORT, DeviceType::key_t::NEARLINK_PORT},
...
static const std::map<TaiheAudioEnum::AudioJsVolumeType, AudioVolumeType> AUDIO_VOLUME_TYPE_TAIHE_MAP = {
    ...
    {TaiheAudioEnum::AudioJsVolumeType::NOTIFICATION, AudioVolumeType::key_t::NOTIFICATION},
...
const std::map<std::string, int32_t> TaiheAudioEnum::deviceTypeMap = {
    ...
    {"BLUETOOTH_SPP", OHOS::AudioStandard::DeviceType::DEVICE_TYPE_BT_SPP},
    {"NEARLINK_PORT", OHOS::AudioStandard::DeviceType::DEVICE_TYPE_NEARLINK_PORT},
...
static const std::map<OHOS::AudioStandard::AudioSessionStateChangeHint,
    ...
    {OHOS::AudioStandard::AudioSessionStateChangeHint::MUTE,
        AudioSessionStateChangeHint::key_t::AUDIO_SESSION_STATE_CHANGE_HINT_MUTE},
    {OHOS::AudioStandard::AudioSessionStateChangeHint::UNMUTE,
        AudioSessionStateChangeHint::key_t::AUDIO_SESSION_STATE_CHANGE_HINT_UNMUTE},
};
...
#ifdef FEATURE_AUDIO_ZONE
            result = TaiheAudioEnum::ToTaiheAudioVolumeType(TaiheAudioEnum::NAVIGATION);
#else
            result = TaiheAudioEnum::ToTaiheAudioVolumeType(TaiheAudioEnum::MEDIA);
#endif
            break;
...
#if !defined(ANDROID_PLATFORM) && !defined(IOS_PLATFORM)
            result = TaiheAudioEnum::ToTaiheAudioVolumeType(TaiheAudioEnum::NOTIFICATION);
#else
            result = TaiheAudioEnum::ToTaiheAudioVolumeType(TaiheAudioEnum::RINGTONE);
#endif
            break;
...
#if !defined(ANDROID_PLATFORM) && !defined(IOS_PLATFORM)
            result = OHOS::system::GetBoolParameter("const.audio.volume_apply_to_all", false) ?
                TaiheAudioEnum::ToTaiheAudioVolumeType(TaiheAudioEnum::SYSTEM) :
                TaiheAudioEnum::ToTaiheAudioVolumeType(TaiheAudioEnum::NOTIFICATION);
#else
            result = TaiheAudioEnum::ToTaiheAudioVolumeType(TaiheAudioEnum::RINGTONE);
#endif
            break;
...
bool TaiheAudioEnum::IsLegalInputArgumentSetMediaOutputDeviceType(int32_t deviceType)
{
    bool result = false;
    switch (deviceType) {
        case OHOS::AudioStandard::DeviceType::DEVICE_TYPE_SPEAKER:
