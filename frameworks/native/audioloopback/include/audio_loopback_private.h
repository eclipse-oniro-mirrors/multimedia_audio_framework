...
public:
    explicit AudioLoopbackPrivate(AudioLoopbackMode mode, const AppInfo &appInfo, bool isGlobal = false);
    ...
    int32_t GetLoopbackDebugInfo(AudioLoopbackDebugInfo &debugInfo) const override;
