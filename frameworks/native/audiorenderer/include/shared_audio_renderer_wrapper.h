...
public:
    ...
    {
        return sharedAudioRenderer_->StartWithError(cmdType);
    }
    ...
    {
        return sharedAudioRenderer_->DrainWithError();
    }
    ...
    {
        return sharedAudioRenderer_->FlushWithError();
    }
    ...
    {
        return sharedAudioRenderer_->PauseWithError(cmdType);
    }
    ...
    {
        return sharedAudioRenderer_->StopWithError();
    }
    ...
    {
        return sharedAudioRenderer_->ReleaseWithError();
    }
    ...
    {
        return sharedAudioRenderer_->SetMainUseArk(isMainUseArk);
    }
    ...
    {
        return sharedAudioRenderer_->SelectOutputDevice(desc);
    }

    int32_t SetIndependentAudioSessionStrategy(const AudioSessionStrategy &strategy, const uint32_t behavior) override
    {
        return sharedAudioRenderer_->SetIndependentAudioSessionStrategy(strategy, behavior);
    }

    int32_t GetRendererDebugInfo(AudioRendererDebugInfo &debugInfo) const override
    {
        return sharedAudioRenderer_->GetRendererDebugInfo(debugInfo);
    }
    ...
    {
        sharedAudioRenderer_->SetRegisterInterruptCallbackFlag(interruptCallbackFlag);
    }
