...
private:
    ...
    uint32_t GetHdiRenderId(const std::shared_ptr<BluetoothAdapterWrapper> &wrapper);
    uint32_t GetHdiCaptureId(const std::shared_ptr<BluetoothAdapterWrapper> &wrapper);
