...
private:
    ...
    static enum AudioFlag ConvertToAudioInputRouteFlag(int32_t sourceType);
    ...
    void UpdateRawSampleAttr(struct AudioSampleAttributes &param);
    void UpdateEcSampleAttr(struct AudioSampleAttributes &param);
...
private:
    ...
    std::unique_ptr<std::thread> stopThread_ = nullptr;
    ...
    FILE *micInDumpFile_ = nullptr;
    std::string micInDumpFileName_ = "";
    ...
    bool currentScoExcludeFlag_ = false;
