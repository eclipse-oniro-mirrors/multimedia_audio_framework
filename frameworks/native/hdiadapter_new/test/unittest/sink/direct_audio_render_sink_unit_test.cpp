 ...
 */
HWTEST_F(DirectAudioRenderSinkUnitTest, DirectSinkUnitTest_006, TestSize.Level1)
{
    EXPECT_TRUE(sink_ != nullptr);
 ...
 */
HWTEST_F(DirectAudioRenderSinkUnitTest, DirectSinkUnitTest_007, TestSize.Level1)
{
    EXPECT_TRUE(sink_ != nullptr);
