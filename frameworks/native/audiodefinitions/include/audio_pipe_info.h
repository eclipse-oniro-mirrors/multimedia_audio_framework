...
public:
    ...
    bool IsSameName(const std::string &targetPipeName) const
    {
        return name_ == targetPipeName;
    }
    ...
    bool IsPipeMatch(const std::string adapterName, const uint32_t targetFlag);
