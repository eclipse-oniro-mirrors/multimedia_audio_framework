...
public:
    ...
    static int32_t GetByteSizePerFrameWithMicInEc(const AudioStreamParams &params, size_t &result);
    static int32_t GetByteSizePerFrameWithMicIn(const AudioStreamParams &params, size_t &result);
    ...
    static bool IsRendererChannelValid(uint8_t channel, uint8_t encodingType);
    ...
    virtual int32_t SetInMainThreadState(bool isInMainThread) = 0;
    virtual void SetClientID(int32_t clientPid, int32_t clientUid, uint32_t appTokenId, uint64_t fullTokenId) = 0;
    virtual void SetClientDeviceId(const std::string &deviceId) = 0;
    ...
    virtual void CheckInnerCapVoIP() = 0;
    ...
    virtual StreamFocusState GetFocusState() = 0;
    virtual void SetFocusState(StreamFocusState state) = 0;
    ...
    virtual int32_t SetMuteHint(bool mute) = 0;
    ...
    virtual int32_t SetSonicPitch(float pitch) { return ERR_NOT_SUPPORTED; }
    virtual float GetSpeed() = 0;
    virtual int32_t GetAudioDebugInfo(AudioDebugInfo &debugInfo) { return SUCCESS; }
    ...
    virtual int32_t RegisterRemoteDiedCallback(const std::shared_ptr<RemoteDiedCallback> &callback) = 0;
    virtual int32_t UnregisterRemoteDiedCallback() = 0;
    ...
    virtual void SetFastStatusChangeCallback(const std::function<void(FastStatus)> &) {};
    ...
    virtual void UpdateUnderrunInfo(UnderrunInfoType underrunInfoKey, int32_t underrunInfoVal) {}
    ...
    virtual bool ResetStaticPlayPosition() = 0;
