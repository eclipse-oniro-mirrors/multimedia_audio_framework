...
public:
    ...
    virtual int32_t SetAudioEnhanceProperty(const AudioEffectPropertyArray &propertyArray,
    ...
    virtual int32_t NotifyChainToStopStream() = 0;

    virtual int32_t SetAppsMuteStateToChainById(uint64_t sceneKeyCode, bool isMute) = 0;
};
} // namespace AudioStandard
} // namespace OHOS
